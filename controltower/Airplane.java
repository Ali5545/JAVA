...
public class Airplane {
	...
	{
		double x= distance * Math.sin(Math.toRadians(bearing));
		double y= distance * Math.cos(Math.toRadians(bearing)); //converting the dist and bearing into x y coordinates
	...
	public double distTo(Airplane other) {
		double x=distance * Math.sin(Math.toRadians(bearing));
		double y= distance * Math.cos(Math.toRadians(bearing));
		double x2= other.distance * Math.sin(Math.toRadians(other.bearing));
		double y2 = other.distance * Math.cos(Math.toRadians(other.bearing));
		double newx = x2 - x;
		double newy = y2 - y;
